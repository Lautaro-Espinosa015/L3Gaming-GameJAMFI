...
public class Camara3Persona : MonoBehaviour
{
    ...
    [Range(0.01f, 0.5f)]
    public float smoothTime = 0.01f; // ¡CLAVE ANTI-PARPADEO! Un valor bajo la mantiene estable.
    ...
    private float rotacionX = 15f; // Ángulo vertical 
    private float rotacionY = 0f;  // Ángulo horizontal 
